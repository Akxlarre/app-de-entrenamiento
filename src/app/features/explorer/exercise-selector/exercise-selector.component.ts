...
import { 
  ...
  IonList, IonItem, IonLabel, IonBadge, IonIcon, IonSpinner, IonInfiniteScroll, IonInfiniteScrollContent
} from '@ionic/angular';
import { ExerciseFacade, ExerciseDefinition } from '@core/facades/exercise.facade';
import { DrawerComponent } from '@shared/components/drawer/drawer.component';
import { IconComponent } from '@shared/components/icon/icon.component';
import { addIcons } from 'ionicons';
import { closeOutline, searchOutline, closeCircleOutline } from 'ionicons/icons';
...
@Component({
  ...
  imports: [
    IonHeader, IonToolbar, IonContent, 
    IonList, IonItem, IonLabel, IonBadge, IonIcon, IonSpinner, IonInfiniteScroll, IonInfiniteScrollContent, DrawerComponent, IconComponent
  ],
  template: `
    <!-- Top Modal Header -->
        ...
        <div class="exercise-card-list">
          @for (exercise of facade.exercises().slice(0, displayLimit()); track exercise.id) {
            <div class="exercise-row-card">
              <div class="flex-1 min-w-0 flex items-center gap-3" (click)="selectExercise(exercise)">
                ...
                <div class="exercise-details min-w-0">
                  <h3 class="exercise-name capitalize truncate">{{ exercise.name_es || exercise.name_en }}</h3>
                  <p class="exercise-meta m-0 text-xs flex items-center gap-1.5 capitalize truncate">
