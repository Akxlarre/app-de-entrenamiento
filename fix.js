const fs = require('fs');
const content = \import { Component, ChangeDetectionStrategy, input } from '@angular/core';
...
\;
fs.writeFileSync('src/app/shared/components/app-header/app-header.component.ts', content);
