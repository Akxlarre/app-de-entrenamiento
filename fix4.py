...
content = content.replace("emoji: '🛡️'", "icon: 'shield-check'")
content = content.replace("emoji: '🦅'", "icon: 'layers'")
content = content.replace("emoji: '🦵'", "icon: 'activity'")
content = content.replace("emoji: '🏋️'", "icon: 'dumbbell'")
content = content.replace("emoji: '💪'", "icon: 'activity'")
content = content.replace("emoji: '🦾'", "icon: 'activity'")
